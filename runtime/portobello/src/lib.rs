...
//! The Portobello runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use runtime_common::{
	claims, impl_runtime_weights, paras_registrar, prod_or_fast, BlockHashCount, BlockLength,
...
use frame_support::{
	...
	traits::{Contains, EnsureOneOf, KeyOwnerProofSystem, LockIdentifier, PrivilegeCmp},
...
use primitives::v2::{
	Balance, BlockNumber, CandidateEvent, CandidateHash, CommittedCandidateReceipt, CoreState,
...
use portobello_runtime_constants::{currency::*, fee::*, time::*};
...
// Portobello types
mod types;
use types::{AccountId20 as AccountId, DealWithFees, EthereumSignature as Signature};

pub mod xcm_config;

impl_runtime_weights!(portobello_runtime_constants);
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("portobello"),
	impl_name: create_runtime_str!("portobello-rs"),
	authoring_version: 0,
	spec_version: 1,
	impl_version: 0,
...
pub struct NoInflationPayout;
impl pallet_staking::EraPayout<Balance> for NoInflationPayout {
	fn era_payout(_a: Balance, _b: Balance, _c: u64) -> (Balance, Balance) {
		(0, 0)
	}
}
...
impl pallet_staking::Config for Runtime {
	...
	type EraPayout = NoInflationPayout;
