...
use xcm_builder::{
	...
	IsConcrete, LocationInverter, SignedAccountKey20AsNative, SignedToAccountId20,
	SovereignSignedViaLocation, TakeWeightCredit, UsingComponents,
};

use crate::types::ToAuthor;
...
parameter_types! {
	...
	pub const PortobelloNetwork: NetworkId = NetworkId::Portobello;
...
pub type SovereignAccountOf = (
	...
	AccountKey20Aliases<PortobelloNetwork, AccountId>,
);
...
type LocalOriginConverter = (
	...
	SignedAccountKey20AsNative<PortobelloNetwork, Origin>,
);
...
pub type LocalOriginToLocation = (
	...
	SignedToAccountId20<Origin, AccountId, PortobelloNetwork>,
);
