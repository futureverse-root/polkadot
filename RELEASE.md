...
1. To initiate the release process:
  ...
  2. In the [substrate](https://github.com/futureverse-root/substrate) repo, check out the commit used by polkadot (this can be found using the following command in the *polkadot* repo: `grep 'paritytech/substrate' Cargo.lock | grep -E '[0-9a-f]{40}' | sort | uniq `
